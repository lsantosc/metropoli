...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "test/support/csv/cities.csv",
    "test/support/csv/countries.csv",
    "test/support/csv/states.csv",
    ...
    "test/test_seed_helper.rb",
    "test/test_web_api.rb"
  ]
  s.homepage = "http://github.com/adriancuadros/metropoli"
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.24"
  s.summary = "City database engine for rails 3"
